...
(function (global, factory) {
  ...
  var alphanumeric = {
      en: /^[0-9A-Z]*$/i,
      cs: /^[0-9A-ZÁCDÉEÍNÓRŠTÚUÝŽ]*$/i,
      da: /^[0-9A-ZÆØÅ]$/i,
      de: /^[0-9A-ZÄÖÜß]*$/i,
      es: /^[0-9A-ZÁÉÍÑÓÚÜ]*$/i,
      fr: /^[0-9A-ZÀÂÆÇÉÈÊËÏÎÔŒÙÛÜŸ]*$/i,
      lt: /^[0-9A-ZACEEIŠUUŽ]*$/i,
      hu: /^[0-9A-ZÁÉÍÓÖOÚÜU]*$/i,
      nl: /^[0-9A-ZÉËÏÓÖÜ]*$/i,
      pl: /^[0-9A-ZACESLNÓZZ]*$/i,
      pt: /^[0-9A-ZÃÁÀÂÇÉÊÍÕÓÔÚÜ]*$/i,
      ru: /^[0-9?-??]*$/i,
      sk: /^[0-9A-ZÁÄCDÉÍLLNÓRŠTÚÝŽ]*$/i,
      sr: /^[0-9A-ZCCŽŠÐ]*$/i,
      tr: /^[0-9A-ZÇGIiÖSÜ]*$/i,
      uk: /^[0-9?-????????]*$/i,
      ar: /^[??????????0-9?????????????????????????????????????????????]*$/
  ...
  var alphaDash = {
      en: /^[0-9A-Z_-]*$/i,
      cs: /^[0-9A-ZÁCDÉEÍNÓRŠTÚUÝŽ_-]*$/i,
      da: /^[0-9A-ZÆØÅ_-]*$/i,
      de: /^[0-9A-ZÄÖÜß_-]*$/i,
      es: /^[0-9A-ZÁÉÍÑÓÚÜ_-]*$/i,
      fr: /^[0-9A-ZÀÂÆÇÉÈÊËÏÎÔŒÙÛÜŸ_-]*$/i,
      lt: /^[0-9A-ZACEEIŠUUŽ_-]*$/i,
      nl: /^[0-9A-ZÉËÏÓÖÜ_-]*$/i,
      hu: /^[0-9A-ZÁÉÍÓÖOÚÜU_-]*$/i,
      pl: /^[0-9A-ZACESLNÓZZ_-]*$/i,
      pt: /^[0-9A-ZÃÁÀÂÇÉÊÍÕÓÔÚÜ_-]*$/i,
      ru: /^[0-9?-??_-]*$/i,
      sk: /^[0-9A-ZÁÄCDÉÍLLNÓRŠTÚÝŽ_-]*$/i,
      sr: /^[0-9A-ZCCŽŠÐ_-]*$/i,
      tr: /^[0-9A-ZÇGIiÖSÜ_-]*$/i,
      uk: /^[0-9?-????????_-]*$/i,
      ar: /^[??????????0-9?????????????????????????????????????????????_-]*$/
