									<div>
										<template v-if="erroreNido.stato" v-cloak>
											<div :class="'alert fade show alert-'+erroreNido.tipo" role="alert">
												<p v-html="erroreNido.messaggio"></p>
											</div>
										</template>
										<template v-else-if="checkNotificatore === false" v-cloak>
											<template v-if="domanda.statoDomanda == 'BOZ'" v-cloak>
												<div class="areaAccodion" id="collapseMobile-01">															
													<div class="box-nav">
														...
														<p class="type-registration nido-infanzia">Nidi d'infanzia</p>
													</div>
															...
															<li :class="{ active: steps.corrente == 1, past: steps.corrente > 1, disable: steps.corrente == 4}" @click="setStep(1)">
																...
																<template v-if="steps.corrente == 1">
																	<ul>
																		...
																		<li :class="{ active: steps[steps.corrente].corrente == 10, past: steps[steps.corrente].corrente > 10}" @click="setSubStep(10)">
																			<span>
											...
											<template v-if="steps.corrente == 1">
												<template v-if="steps[steps.corrente].corrente == 1">
													<?php require_once('template/nidi/steps/step1/subStep1.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 2">
													<?php require_once('template/nidi/steps/step1/subStep2.php'); ?>										
												</template>
												<template v-if="steps[steps.corrente].corrente == 3">
													<?php require_once('template/nidi/steps/step1/subStep3.php'); ?>											
												</template>
												<template v-if="steps[steps.corrente].corrente == 4">
													<?php require_once('template/nidi/steps/step1/subStep4.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 5">
													<?php require_once('template/nidi/steps/step1/subStep5.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 6">
													<?php require_once('template/nidi/steps/step1/subStep6.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 7">
													<?php require_once('template/nidi/steps/step1/subStep7.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 8">
													<?php require_once('template/nidi/steps/step1/subStep8.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 9">
													<?php require_once('template/nidi/steps/step1/subStep9.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 10">
													<?php require_once('template/nidi/steps/step1/subStep10.php'); ?>
												</template>
											</template>
											<template v-if="steps.corrente == 2">
												<template v-if="steps[steps.corrente].corrente == 1">
													<?php require_once('template/nidi/steps/step2/subStep1.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 2">
													<?php require_once('template/nidi/steps/step2/subStep2.php'); ?>
												</template>
												<template v-if="steps[steps.corrente].corrente == 3">
													<?php require_once('template/nidi/steps/step2/subStep3.php'); ?>
												</template>
											</template>
											<template v-if="steps.corrente == 3">
												<template v-if="steps[steps.corrente].corrente == 1">
													<?php require_once('template/nidi/steps/step3/subStep1.php'); ?>
												</template>
											</template>
											<template v-if="steps.corrente == 4">
												<template v-if="steps[steps.corrente].corrente == 1">
													<?php require_once('template/nidi/steps/step4/subStep1.php'); ?>
												</template>
											</template>
										</template>
									</div>					