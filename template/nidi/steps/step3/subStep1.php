										<h2 :class="domanda.statoDomanda == 'BOZ' ? 'no-bottom' : 'titleMobile'">{{ domanda.statoDomanda == 'BOZ' ? 'Riepilogo domanda' : 'Dati domanda' }} <span class="badge badge-light border border-dark">A.S. {{ domanda.annoScolastico | annoScolasticoNido(famiglia.annoLimiteNido) }}</span></h2>
										<div class="form-step form-step-detail">
											...
											<div id="accordion-isee" class="box-accordion">
												<div class="card">
													<div class="card-header" id="dati-isee">
														<div class="accordion-action collapsed" data-toggle="collapse" data-target="#isee" aria-expanded="false" aria-controls="isee">
															<strong>Dati relativi all'ISEE</strong>
														</div>
													</div>
													<div id="isee" class="collapse" aria-labelledby="dati-isee">
														<div class="card-body">
															<div class="form-row">
																<div class="form-group col-md-12">
																	<strong>Il nucleo del bambino o bambina &egrave; in possesso di un indicatore ISEE</strong>: {{ domanda.isee.stato | siNo }}
																</div>
																<div class="form-group col-md-12 ml-3" v-if="domanda.isee.stato === true">
																	<strong>Valore ISEE</strong>: {{ domanda.isee.dati.valore | euro }}<br />
																	<strong>Valido fino al</strong>: {{domanda.isee.dati.dataAttestazione}}
																</div>
															</div>
														</div>
													</div>
												...
												<div class="card">
													<div class="card-header" id="trasferimento">
														<div class="accordion-action collapsed" data-toggle="collapse" data-target="#dati-trasferimento" aria-expanded="false" aria-controls="dati-trasferimento">
															<strong>Cambio del nido di frequenza</strong>
														</div>
													</div>
													<div id="dati-trasferimento" class="collapse" aria-labelledby="trasferimento">
														<div class="card-body">
															<div class="form-row">
																<div class="form-group col-md-12">
																	<strong>Cambio nido perch&eacute; variato l'indirizzo di residenza del bambino o bambina</strong>: {{ domanda.minore.trasferimento.stato | siNo }}
																</div>
																<div class="form-group col-md-12 ml-3" v-if="domanda.minore.trasferimento.stato === true">
																	...
																	<strong>Indirizzo nido di provenienza</strong>: {{domanda.minore.trasferimento.dati.indirizzo}}<br />
																	<strong>Frequenza nido di provenienza dal</strong>: {{domanda.minore.trasferimento.dati.dataDal}}<br />
																</div>
															</div>
														</div>
													</div>
												...
												<div class="card">
													<div class="card-header" id="spostamento">
														<div class="accordion-action collapsed" data-toggle="collapse" data-target="#dati-spostamento" aria-expanded="false" aria-controls="dati-spostamento">
															<strong>Spostamento residenza a Torino</strong>
														</div>
													</div>
													<div id="dati-spostamento" class="collapse" aria-labelledby="spostamento">
														<div class="card-body">
															<div class="form-row">
																<div class="form-group col-md-12">
																	<strong>Richiesta attribuzione del punteggio come famiglia residente a Torino</strong>: {{ domanda.minore.spostamento.stato | siNo }}
																</div>
																<div class="form-group col-md-12" v-if="domanda.minore.spostamento.stato === true">
																	<template v-if="domanda.minore.spostamento.dati.stato == 'VAR_RES'">
																		<strong>Fatta richiesta di variazione residenza in data</strong>: {{ domanda.minore.spostamento.dati.dataVariazione }}
																	</template>
																	<template v-else-if="domanda.minore.spostamento.dati.stato == 'APP_VAR_RES'">
																		<strong>Preso appuntamento all'anagrafe della Citt&agrave; di Torino per variazione di residenza in data</strong>: {{ domanda.minore.spostamento.dati.dataAppuntamento }}
																	</template>
																	<template v-else-if="domanda.minore.spostamento.dati.stato == 'RES_FUT'">
																		<strong>Futuro trasferimento a Torino e presentazione richiesta di variazione di residenza per i seguenti motivi</strong>:<br />
											...
											<div id="accordion-elenco-nidi" class="box-accordion">
												<div class="card">
													<div class="card-header" id="elenco-nidi">
														<div class="accordion-action collapsed" data-toggle="collapse" data-target="#dati-elenco-nidi" aria-expanded="false" aria-controls="dati-elenco-nidi">
															<strong>Nidi selezionati</strong>
														</div>
													</div>
													<div id="dati-elenco-nidi" class="collapse" aria-labelledby="elenco-nidi">
														<div class="card-body">
															<div v-for="(nido, index) in domanda.elencoNidi" :key="index" :class="['form-row', 'border-dark', 'pb-4', {'border-bottom': index < domanda.elencoNidi.length-1, 'pt-4':index > 0}]">
																<div class="form-group col-md-12">
												...
												<div class="card">
													<div class="card-header" id="accordion-fratello">
														<div class="accordion-action collapsed" data-toggle="collapse" data-target="#dati-fratello" aria-expanded="false" aria-controls="dati-fratello">
															<strong>Altri figli o figlie frequentanti o in corso di iscrizione</strong>
														</div>
													</div>
													...
													<div id="presa-visione" class="collapse" aria-labelledby="visione-informative">
														<div class="card-body">
															<div class="form-row">
																...
																<div class="form-group col-md-12" v-if="domanda.consensoConvenzionata != ''">
																	<strong>Dichiarazione sul consenso al trattamento dei dati da parte del titolare della sezione primavera eventualmente scelta</strong> <i class="fas fa-check text-success"></i>
																</div>																
															</div>
														</div>
													</div>
											...
											<?php if (isset($_SESSION['ISCRIZIONI']['user']['authprovider']) && $_SESSION['ISCRIZIONI']['user']['authprovider'] == 'IPA'): ?>
												<div class="card mt-9">
													<div class="card-body">
														...
														<p><small>Dichiaro di consentire al trattamento dei dati da parte del titolare della sezione primavera eventualmente scelta.</small></p>
