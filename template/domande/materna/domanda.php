												<div>
													...
													<div class="form-step" v-if="domanda">
														...
														<div :id="posto.codStatoScuola == 'AMM' ? 'ammesso' : ''" :class="['list-link', 'list-link-nidi', {'ammesso': posto.codStatoScuola == 'AMM'}]" v-for="(posto, index) in domanda.elencoPreferenzeMaterna" :key="index">
															<div class="choice"><p>
															...
															<div class="detail">
																<p :class="posto.codStatoScuola">
																	<span class="sr-only">Stato: </span>
																	{{posto.codStatoScuola | statoPreferenzaMaterna}}
																</p>
																<h3>{{ posto.descrizione }} <span class="badge badge-scuola">{{ posto.codCategoriaScuola | categoriaScuola('MAT') }}</span></h3>
																<p>
															...
															<div class="btn-group-col" v-if="posto.codStatoScuola == 'AMM'">
																<div class="btn-row">
																	<div class="col">
																		<a href="#" role="button" class="btn btn-primary" @click="accetta(domanda, index, 'materna')">Accetta</a>
																	</div>
																	<div class="col">
																		<a href="#" role="button" class="btn btn-secondary" @click="rinuncia(domanda, index, 'materna')">Rinuncia</a>
																	</div>
																</div>
															</div>
														</div>
