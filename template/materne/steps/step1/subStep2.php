	...
	<div class="card mb-4">
		<div class="card-body">
			<div class="custom-control custom-checkbox">
				...
				<label class="custom-control-label" for="responsabilita-genitoriale">Dichiaro che alla luce delle norme del codice civile sopra richiamate in materia di responsabilit&agrave; genitoriale la richiesta di iscrizione e la scelta delle scuole &egrave; condivisa dai genitori o, nel caso di responsabilit&agrave; genitoriale esclusiva, dichiaro di essere l'unico genitore con responsabilit&agrave; genitoriale<sub class="required">*</sub></label>
...
<div class="form-step">
	...
	<div class="form-row mt-8">
		<div class="custom-control custom-checkbox">
			...
			<label class="custom-control-label" for="consenso-convenzionata">Dichiaro di consentire al trattamento dei dati da parte del gestore della scuola convenzionata eventualmente scelta<sub class="required">*</sub></label><br />
