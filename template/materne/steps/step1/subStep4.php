...
<div class="form-step">
	...
	<template v-if="famiglia.minorenniMaterna[this.domanda.annoScolastico]" v-cloak>
		<div id="minore-presenza-nucleo" class="form-row">
			...
			<template v-if="(famiglia.minorenniMaterna[this.domanda.annoScolastico].length > 0 && domanda.minore.presenzaNucleo === true)" v-cloak>
				<div id="minore-nucleo" class="form-group col-md-12">
					...
					<hr />
					<div v-for="(iscritto, index) in famiglia.minorenniMaterna[this.domanda.annoScolastico]" :key="index" class="custom-control custom-radio">
						<input type="radio" :id="'maternaMinore'+index" name="minore-nucleo" :class="{'custom-control-input':true, 'is-invalid': errors.has('minore-nucleo')}" :value="iscritto.anagrafica.codiceFiscale" v-model="domanda.minore.anagrafica.codiceFiscale" v-validate.disable="'required'" @change="setMinore" />
						<label class="custom-control-label" :for="'maternaMinore'+index">
	...
	<template v-if="showFormMinore" v-cloak>
		<template v-if="showFormAnagraficaMinore" v-cloak>
			...
			<anagrafica v-model="domanda.minore.anagrafica" :ora="true" :check-data="famiglia.anniScolasticiMaterna[this.domanda.annoScolastico].annoLimite" :cittadinanza="cittadinanza" target="minoreMat" key="minoreAnagrafica"></anagrafica>
					...
					<div class="card hight col-md-10 mb-4 ml-2">
						<div class="card-body">
							<div class="alert alert-info fade show" role="alert">
								<p>Allegare il profilo descrittivo di funzionamento o la diagnosi funzionale e il certificato INPS di riconoscimento dell'handicap</p>
							</div>
